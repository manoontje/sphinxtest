...
class Visualizer():
    ...
    def __init__(self, grid_size, vis_bg):
        self.agent_states = {}
        self.hu_ag_states = {}
        self.god_state = {}
        self.verbose = False
        ...
        self.__initGUI(grid_size=grid_size, vis_bg=vis_bg)


    def __initGUI(self, grid_size, vis_bg):
        """
        Send an initialization message to the GUI webserver, which sends the grid_size.
        """
        data = {'params': {'grid_size': grid_size, 'vis_bg': vis_bg}}
